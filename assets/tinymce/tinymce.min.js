...
!(function () {
  ...
  const qr = (e, t = !0) =>
    ...
    os = (e, t) => {
      ...
      if (e) {
        for (e = e.split(','), t = t || 10, n = 0; n < e.length; n += 2)
          (o = String.fromCharCode(parseInt(e[n], t))), ts[o] || ((r = '&' + e[n + 1] + ';'), (s[o] = r), (s[r] = o));
        return s;
      }
    },
    rs = os(
        ...
        i = (t, n, o) => {
          ...
          return (
            r
              ...
              : ((r = ds[t]), r || ((r = us(n, ' ', us(n.toUpperCase(), ' '))), (r = fs(r, o)), (ds[t] = r))),
            r
          );
        },
      ...
      const c = {
        parse: (t) => {
          ...
          const f = e.url_converter,
            ...
            b = (e) => ((m = !0), a[e]),
            v = (e, t) => (
              m && (e = e.replace(/\uFEFF[0-9]/g, (e) => a[e])), t || (e = e.replace(/\\([\'\";:])/g, '$1')), e
            ),
          ...
          if (t) {
            for (
              ...
              if (
                ...
                'font-weight' === d && '700' === u
                  ? (u = 'bold')
                  : ('color' !== d && 'background-color' !== d) || (u = u.toLowerCase()),
                  (u = u.replace(n, x)),
                  (i[d] = m ? v(u, !0) : u);
              }
            p('border', '', !0),
              ...
              h((w = 'border-width')) &&
                h(k) &&
                h(S) &&
                ((i.border = i[w] + ' ' + i[k] + ' ' + i[S]), delete i[w], delete i[k], delete i[S]),
          ...
          const o = (t) => {
            ...
            if (r)
              for (let s = 0, a = r.length; s < a; s++)
                (t = r[s]), (o = e[t]), o && (n += (n.length > 0 ? ' ' : '') + t + ': ' + o + ';');
          };
          return (
            t && i
              ? (o('*'), o(t))
    ...
    Ns = (e, t, n) => {
      ...
      'complete' === o.readyState || ('interactive' === o.readyState && o.body) ? s() : Ss(e, 'DOMContentLoaded', s),
            ...
            : (r.hasMouseEnterLeave ||
                ...
                d &&
                  (c = (e) => {
                    ...
                    n ||
                      (((e = Es(e || m.event)).type = 'mouseout' === e.type ? 'mouseleave' : 'mouseenter'),
                      (e.target = t),
      ...
      const a = Yo.forElement(mn(e), { contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy }),
          ...
          L(e, (e) => {
            if (yo(e)) {
              ...
              a && a.set ? a.set(r.dom, o, n) : Bs(r, n, o),
                s !== o && t.onSetAttrib && t.onSetAttrib({ attrElm: r, attrName: n, attrValue: o });
            }
          });
        },
        ...
        I = (t, n, o, r, s) =>
          L(t, (t) => {
            ...
            return (
              C(o) && P(a, o), r && (!m(r) && r.nodeType ? a.appendChild(r) : m(r) && M(a, r)), s ? a : t.appendChild(a)
            );
          }),
        ...
        J = ((e, t, n) => {
          const o = t.keep_values,
            r = {
              set: (e, o, r) => {
                const s = mn(e);
                x(t.url_converter) && C(o) && (o = t.url_converter.call(t.url_converter_scope || n(), o, r, e[0])),
                  Bs(s, 'data-mce-' + r, o),
                  Bs(s, r, o);
              },
              get: (e, t) => {
          ...
          (n = ((e) => {
            const t = [],
              ...
              o = (e, o) => {
                ...
                o > 0 && (r.setStart(e, o - 1), r.setEnd(e, o), Pa(r) || n(Fa(Ia(r), !1))),
                  o < e.data.length && (r.setStart(e, o), r.setEnd(e, o + 1), Pa(r) || n(Fa(Ia(r), !0)));
              },
              r = e.container(),
              s = e.offset();
  ...
  const za = (e, t) => {
    ...
    Wa = (e) =>
      e ? Oe(e.childNodes, (e, t) => (Ha(t) && 'BR' !== t.nodeName ? (e = e.concat(Wa(t))) : e.push(t), e), []) : [],
    Ka = (e) => (t) => e === t,
    Ga = (e) => {
      let t;
      return (
        ...
        No(s)
          ? i.push(
              n
                ? ((e, t, n) => {
                    let o, r;
                    for (r = e(t.data.slice(0, n)).length, o = t.previousSibling; o && No(o); o = o.previousSibling)
                      r += e(o.data).length;
                    return r;
                  })(t, s, a)
                : a
    ...
    ei = (e, t) => {
      ...
      (n = e[s + 'Container']),
        ...
        yo(n) &&
          ...
          n && ((o = t ? 0 : n.childNodes.length), e['set' + (t ? 'Start' : 'End')](n, o)));
    },
  ...
  const ui = (e) => 'inline-command' === e.type || 'inline-format' === e.type,
    ...
    gi = (e) =>
      ((e) => se(e, (e, t) => (e.start.length === t.start.length ? 0 : e.start.length > t.start.length ? -1 : 1)))(
        K(e, mi)
      ),
    pi = (e) => K(e, ui),
    hi = (e) => {
  ...
  const qd = Mo,
    ...
    ac = (e, t, n) =>
      sc(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !rc(t, n) && ((o = t), !(!Ua.isTextPosition(o) && Do(o.getNode()))) && oc(t) && nc(n)
            : !rc(n, t) && nc(t) && oc(n);
          var o;
        })(e, n, o)
          ? sc(e, t, o)
    ...
    vc = (e, t) =>
      mc(e).fold(L, (e) => (t.setStart(e.container(), e.offset()), t.setEnd(e.container(), e.offset()), !0)),
    yc = (e, t, n) =>
      !(
      ...
      if (i) {
        if (
          ...
          a &&
            ...
            No(a) &&
            !Nt.browser.isOpera() &&
            ((r = a.nodeValue.length), a.appendData(s.nodeValue), e.remove(s), (d = a), (c = r));
        }
    ...
    Ic = (e, t, n) => {
      ...
      if ((r !== n.endContainer || !(s = r.childNodes[o]) || !/^(IMG)$/.test(s.nodeName)) && yo(r)) {
        ...
        o < s.length
          ...
          : ((r = s[s.length - 1]), (a = new Xo(r, e.getParent(r, e.isBlock))), a.next(!0));
    ...
    mu = (e, t, n, o = !1) => {
      ...
      return (
        ...
        (Gc(d) || Yc(d)) &&
          ...
          Gc(d) && (l.isBlock(r) || (r = cu(l, n, r, s, !0)), l.isBlock(a) || (a = cu(l, n, a, i, !1)))),
  ...
  const Bu = (e, t, n) =>
      !n.collapsed &&
      V(n.getClientRects(), (n) => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t)),
      ...
      const E = { nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1] },
        ...
        T = (e) => {
          ...
          return (
            ...
            e !== t.getBody() &&
            (o.hasClass(e, 'mce-preview-object') ? pn(mn(e.firstElementChild), n) : pn(mn(e), n))
          );
        },
        B = (e, n, r) => {
          if (C(r)) {
                    ...
                    r.stopImmediatePropagation(),
                      ...
                      ((r) => {
                        ...
                        (c = r.screenX),
                          ...
                          (S = k.scrollWidth),
                          (_ = k.scrollHeight),
                          (d = o.add(k, 'div', { class: 'mce-resize-backdrop', 'data-mce-bogus': 'all' })),
                          o.setStyles(d, { position: 'fixed', left: '0', top: '0', width: '100%', height: '100%' }),
                          (a = R((h = s)) ? o.create('img', { src: Nt.transparentSrc }) : h.cloneNode(!0)),
                          ...
                          o.bind(v, 'mouseup', P),
                          y !== v && (o.bind(y, 'mousemove', L), o.bind(y, 'mouseup', P)),
                          (i = o.add(
                            k,
                            'div',
        ...
        F = (s) => {
          ...
          p ||
            ...
            (l =
              null === (a = Ko(mn(l), 'table,img,figure.image,hr,video,span.mce-preview-object').getOrUndefined()) ||
              void 0 === a
                ? void 0
                : a.dom),
      ...
      return ((e, t) => {
        const n = ((e, t) =>
          t.match({
            ...
            relative: (t, n) => ({ ltr: De(() => ju(e, t, n)), rtl: De(() => M.some(ju(e, n, t))) }),
            exact: (t, n, o, r) => ({ ltr: De(() => Vu(e, t, n, o, r)), rtl: De(() => M.some(Vu(e, o, r, t, n))) }),
          }))(e, t);
        return ((e, t) => {
          const n = t.ltr();
          return n.collapsed
    ...
    cm = (e, t, n, o, r) => {
      ...
      for (; (i = c[o ? 'prev' : 'next']()); ) {
        ...
        if (No(i) && i.nodeValue.length > 0)
          return !1 === sm(i, a, 'A') ? M.some(Ua(i, o ? i.nodeValue.length : 0)) : M.none();
      ...
      return (
        t === o && No(t)
          ? n > 0 &&
            ...
            ((o = fm(t, n)),
            (t = o.previousSibling),
            r > n ? ((r -= n), (t = o = fm(o, r).previousSibling), (r = o.nodeValue.length), (n = 0)) : (r = 0))
          : (No(t) && n > 0 && n < t.nodeValue.length && ((t = fm(t, n)), (n = 0)),
            No(o) && r > 0 && r < o.nodeValue.length && ((o = fm(o, r).previousSibling), (r = o.nodeValue.length))),
  ...
  const Xm = Is.DOM,
    ...
    ef = (e, t) => {
      ((e, t) =>
        ((e) => (e.collapsed ? M.from(ya(e.startContainer, e.startOffset)).map(mn) : M.none()))(t).bind((t) =>
  ...
  class yf {
    ...
    insert(e, t, n) {
      ...
      return (
        n
          ? (t === o.firstChild ? (o.firstChild = e) : (t.prev.next = e), (e.prev = t.prev), (e.next = t), (t.prev = e))
          : (t === o.lastChild ? (o.lastChild = e) : (t.next.prev = e), (e.next = t.next), (e.prev = t), (t.next = e)),
        (e.parent = o),
        e
      );
    }
  ...
  const Cf = (e, t, n = 0) => {
    ...
    _f = (e) => ({
      compare: (t, n) => {
        ...
        return !(
          !r(o(t), o(n)) ||
          !r(e.parseStyle(e.getAttrib(t, 'style')), e.parseStyle(e.getAttrib(n, 'style'))) ||
          _c(t) ||
          _c(n)
        );
      },
    ...
    Nf = (e) => {
      ...
      return {
        start: (e, i, l) => {
          let d, c, u, m;
          if (
            (n && o[e] && t.length > 0 && ((m = t[t.length - 1]), m.length > 0 && '\n' !== m && t.push('\n')),
            t.push('<', e),
            i)
          )
            for (d = 0, c = i.length; d < c; d++) (u = i[d]), t.push(' ', u.name, '="', s(u.value, !0), '"');
          (t[t.length] = !l || a ? '>' : ' />'),
            l && n && r[e] && t.length > 0 && ((m = t[t.length - 1]), m.length > 0 && '\n' !== m && t.push('\n'));
        },
        end: (e) => {
          let o;
          t.push('</', e, '>'),
  ...
  const Of = ['font', 'text-decoration', 'text-emphasis'],
              ...
              ((e) => {
                const t = e.data,
                  n = ((e) => {
                    const t = e.split('');
                    return H(t, (e, n) =>
                      Ec(e) && n > 0 && n < t.length - 1 && Rc(t[n - 1]) && Rc(t[n + 1]) ? ' ' : e
                    ).join('');
                  })(t);
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome()
            ...
            : M.none()).orThunk(() => (n && (o.each((e) => _g(e.dom, e.dom.length)), r.each((e) => Sg(e.dom, 0))), t))
        );
        var s, a, i, l;
              ...
              qr(o)
                ...
                : ((e, t, n, o, r) =>
                    ac(n, e.getBody(), r).bind((e) =>
                      tp(t, mn(e.getNode())).bind((e) => (bn(e, o) ? M.none() : M.some(S)))
                    ))(e, n, t, o, r)
            );
          })(e, t, o, n).orThunk(() =>
            Pt(
                  ...
                  ac(n, e.getBody(), r).fold(
                    ...
                    (s) =>
                      ((e, t, n, o) =>
                        uc(e.dom)
                          .bind((r) =>
                            mc(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r)))
                          )
                          .getOr(!0))(o, n, r, s)
                        ? ((e, t) => op(e, t))(e, o)
                        : ((e, t, n) =>
      ...
      for (let l = 0; l < e.length; l++) {
        ...
        if (c && f.length > 1)
          if (t.isValidChild(c.name, d.name)) {
            ...
            gp(t, r, s, u) ? c.insert(d, f[0], !0) : (c.insert(u, f[0], !0), c.insert(d, u)),
              (c = f[0]),
    ...
    yp = (e) => {
      return e.length > 0 &&
        (!(n = e[e.length - 1]).firstChild ||
          ((t = n) && t.firstChild && t.firstChild === t.lastChild && ((e) => e.data === dr || Do(e))(t.firstChild)))
        ? e.slice(0, -1)
        : e;
      var t, n;
    },
    ...
    Sp = (e, t, n) => {
      ...
      m === f &&
        ...
        ((r = i.createRng()), r.setStart(f.firstChild, 0), r.setEnd(f.firstChild, 0), a.setRng(r)),
        a.isCollapsed() ||
          ((e) => {
            const t = e.dom,
            ...
            ((e, t, n) => null !== n && n === e.getParent(t.endContainer, kp) && Cu(mn(n), t))(t, n, o)
              ? Zg(e, n, mn(o))
    ...
    Bp = (e, t, n, o, r) => {
      ...
      return (
        t !== s &&
        ((t = e.dom.getParent(t, (t) => !!Tp(e, t, n) || t.parentNode === s || !!Pp(e, t, n, o, !0))),
        !!Pp(e, t, n, o, r))
      );
    },
    Dp = (e, t, n) =>
      !(!Xc(n) || !Op(t, n.inline)) || !(!Gc(n) || !Op(t, n.block)) || (!!Yc(n) && yo(t) && e.is(t, n.selector)),
    Lp = (e, t, n, o, r, s) => {
      const a = n[o];
      ...
      if (a)
        if (v(a.length)) {
          ...
          for (let n = 0; n < a.length; n++) if ('attributes' === o ? e.getAttrib(t, a[n]) : qc(e, t, a[n])) return !0;
      return !0;
    },
    Pp = (e, t, n, o, r) => {
  ...
  const Qp = Bt.each,
    ...
    gh = (e, t, n, o, r) => {
      ...
      if (Xc(t) && 'all' === t.remove && p(t.preserve_attributes)) {
        ...
        if ((a.removeAllAttribs(i), $(e, (e) => a.setAttrib(i, e.name, e.value)), e.length > 0))
          ...
          ih(t.attributes, (e, o) => {
            ...
            if (((e = Vc(e, n)), w(o) && ((o = e), (r = null)), t.remove_similar || !r || lh(a.getAttrib(r, o), e))) {
              ...
              if (
                ...
                'style' === o && Co(['li'])(i) && 'none' === a.getStyle(i, 'list-style-type'))
              )
                return i.removeAttribute(o), void a.setStyle(i, 'list-style-type', 'none');
    ...
    hh = (e, t, n, o) =>
      gh(e, t, n, o, o).fold(N(o), (t) => (e.dom.createFragment().appendChild(o), e.dom.rename(o, t)), N(null)),
    bh = (e, t, n, o, r) => {
          ...
          return ((e, t, n, o, r, s, a, i) => {
            ...
            if (n) {
              ...
              (a.mixed && u.isBlock(n)) || (o = u.split(n, o)),
                d && (r.parentNode.insertBefore(d, r), c.appendChild(r), Xc(a) && th(u, a, 0, d));
            }
            return o;
          })(e, s, i, o, o, 0, a, n);
        },
        ...
        m = (t) => {
          ...
          $(['underline', 'line-through', 'overline'], (n) => {
            yo(t) &&
              ...
              t.parentNode &&
              Wc(l, t.parentNode) === n &&
              ph(e, { deep: !1, exact: !0, inline: 'span', styles: { textDecoration: n } }, null, t);
          });
        },
        f = (e) => {
                ...
                ? (Xc(s) || (Gc(s) && s.wrapper)) &&
                  ...
                  ((e, t, n, o) => {
                    t.styles &&
                      ...
                      nh(o, oh(e, 'fontSize'), rh(e, 'backgroundColor', Vc(t.styles.backgroundColor, n)));
                  })(o, s, n, a),
                  ((e, t, n, o) => {
                    const r = (t) => {
  ...
  var Cb = function () {
    ...
    wb = (function e() {
      ...
      if (((n.version = '2.3.6'), (n.removed = []), !t || !t.document || 9 !== t.document.nodeType))
      ...
      var Ae = function (e) {
        ...
        Ie = function (e) {
          ...
          return e instanceof l && !Ae(e)
            ? (Oe(e), !0)
            : ('noscript' !== o && 'noembed' !== o) || !Kh(/<\/no(script|embed)/i, e.innerHTML)
            ? (G &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = $h(t, T, ' ')),
                (t = $h(t, B, ' ')),
                e.textContent !== t && (jh(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
            ...
            if (
              !(
                (Ue(e) &&
                  ...
                  ((V.attributeNameCheck instanceof RegExp && Kh(V.attributeNameCheck, t)) ||
      ...
      return (
        ...
        (!!/((java|vb)script|mhtml):/i.test(o) ||
          (!e.allow_html_data_urls &&
            (/^data:image\//i.test(o)
              ? ((e, t) => (C(e) ? !e : !C(t) || !j(Lb, t)))(e.allow_svg_data_urls, n) &&
  ...
  const Ib = Bt.makeMap,
          ...
          (r.keepAttr = !o || t.isValid(s, a) || ze(a, 'data-') || ze(a, 'aria-')),
            ...
            r.keepAttr
              ? ((r.allowedAttributes[a] = !0),
                ...
                e.allow_svg_data_urls && ze(i, 'data:image/svg+xml') && (r.forceKeepAttr = !0))
              : !n.hasAttribute(Hb) || ('id' !== a && 'class' !== a && 'style' !== a) || (r.forceKeepAttr = !0);
        }),
        n
      );
    },
                ...
                return [
                  (e) => {
                    if (3 === e.type && !u(e)) {
                      let t = e.value;
                      (t = t.replace(l, ' ')),
                        (((e, t) => e && (e.name in t || 'br' === e.name))(e.prev, i) || m(e, !0)) &&
                          (t = t.replace(d, '')),
                      ...
                      if (r && n) {
                        ...
                        n.removeEmpty && r
                          ? i[e.name]
                            ...
                            : e.unwrap()
                          : n.paddEmpty &&
                            (r || ((e) => fp(e, '#text') && e.firstChild.value === dr)(e)) &&
                            mp(0, o, i, e);
                      }
                    } else if (3 === e.type && !u(e)) {
                      let t = e.value;
                      (i[null === (n = e.next) || void 0 === n ? void 0 : n.name] || m(e, !1)) &&
                        (t = t.replace(c, '')),
                        0 === t.length ? e.remove() : (e.value = t);
                    }
                  },
              ...
              w &&
                ...
                ((e, n) => {
                  ...
                  if (t.isValidChild(e.name, n.toLowerCase())) {
                    for (; i; ) {
                      const t = i.next;
                      3 === i.type || (1 === i.type && 'p' !== i.name && !o[i.name] && !i.attr(Hb))
                        ? (l || ((l = new yf(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)), l.append(i))
                        : (d(l), (l = null)),
                        (i = t);
                    }
                    d(l);
    ...
    bv = (e, t, n) => {
      ...
      'fragmented' === t.type
        ...
        : e.setContent(t.content, { format: 'raw', no_selection: !C(o) || !hc(o) || !o.isFakeCaret }),
      ...
      undoManager: {
        ...
        add: (t, n, o, r, s, a) =>
          ((e, t, n, o, r, s, a) => {
            ...
            if (e.dispatch('BeforeAddUndo', { level: s, lastLevel: l, originalEvent: a }).isDefaultPrevented())
              return null;
            ...
            return (
              n.get() > 0
                ? (e.setDirty(!0), e.dispatch('AddUndo', c), e.dispatch('change', c))
        ...
        redo: (t, n) =>
          ((e, t, n) => {
            ...
            return (
              t.get() < n.length - 1 &&
                (t.set(t.get() + 1), (o = n[t.get()]), bv(e, o, !1), e.setDirty(!0), e.dispatch('Redo', { level: o })),
              o
            );
          })(e, t, n),
        clear: (t, n) =>
        ...
        closest: (t) =>
          ((e, t) => {
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) =>
                Ap(mn(o), (n) => ce(t, (t) => ((t, n) => (Pp(e, t.dom, n) ? M.some(n) : M.none()))(n, t)), n)
              )
              .getOrNull();
          })(e, t),
                      ...
                      if (0 === n.length || /^\s+$/.test(n)) {
                        ...
                        return (
                          e.schema.isValidChild(t.nodeName.toLowerCase(), s.toLowerCase())
                            ? ((n = r), (n = e.dom.createHTML(s, Bi(e), n)))
                            : n || (n = r),
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          try {
            (n = d()) &&
              !vo(n.anchorNode) &&
              ((a = n.rangeCount > 0 ? n.getRangeAt(0) : n.createRange ? n.createRange() : c.createRange()),
              (a = df(o, [a])[0]));
          } catch (e) {}
          return (
            a || (a = c.createRange()),
            ...
            r &&
              s &&
              (0 === l(a.START_TO_START, a, r) && 0 === l(a.END_TO_END, a, r) ? (a = s) : ((r = null), (s = null))),
            a
          );
        },
        u = (e, t) => {
          ...
          if (((e = o.dispatch('SetSelectionRange', { range: e, forward: t }).range), a)) {
            ...
            !1 === t &&
              a.extend &&
              (a.collapse(e.endContainer, e.endOffset), a.extend(e.startContainer, e.startOffset)),
          ...
          !e.collapsed &&
            ...
            n &&
              'IMG' === n.tagName &&
              (a.setBaseAndExtent(e.startContainer, e.startOffset, e.endContainer, e.endOffset),
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) => ((e, t, n) => Nv(e).selection.getContent(t, n))(e, t.format ? t.format : 'html', t))(o, e),
          setContent: i,
            ...
            ((e, t, n) =>
              M.from(t).map((t) => {
                const o = e.nodeIndex(t),
                  r = e.createRng();
                return (
                  r.setStart(t.parentNode, o), r.setEnd(t.parentNode, o + 1), n && (xu(e, r, t, !0), xu(e, r, t, !1)), r
                );
              }))(e, t, n).each(u),
            t
          ),
          ...
          e.addAttributeFilter('data-mce-tabindex', (e, t) => {
            ...
            e.addAttributeFilter('class', (e) => {
              ...
              for (; t--; ) {
                ...
                let o = n.attr('class');
                o &&
                  ((o = n.attr('class').replace(/(?:^|\s)mce-item-\w+(?!\S)/g, '')),
              ...
              for (; o--; ) {
                ...
                t.preserve_cdata && 0 === r.value.indexOf('[CDATA[')
                  ...
                  : 0 === r.value.indexOf('mce:protected ') &&
                    ((r.name = '#text'), (r.type = 3), (r.raw = !0), (r.value = unescape(r.value).substr(14)));
              }
            }),
    ...
    iy = (e, t) => {
      const n = e.editorManager.baseURL + '/skins/content',
        ...
        r = !0 === e.inline;
      return H(t, (t) =>
        ((e) => /^[a-z0-9\-]+$/i.test(e))(t) && !r ? `${n}/${t}/${o}` : e.documentBaseURI.toAbsolute(t)
      );
    },
    ly = P,
    dy = () => {
  ...
  const uy = (e, t) => {
                ...
                findAll: (o, r) => {
                  ...
                  const s = K(((e) => (e ? de(e.getElementsByTagName('img')) : []))(o), (t) => {
                      ...
                      return (
                        ...
                        (0 === n.indexOf('blob:') ? !e.isUploaded(n) && r(t) : 0 === n.indexOf('data:') && r(t))
                      );
                    }),
                    a = H(s, (e) => {
                      if (void 0 !== n[e.src])
    ...
    xy = (e, t) => {
      ...
      return e && e.length
        ? ((o = e[0]), (n = a(o)), (r = Cy.create('div')), r.appendChild(i(n, e.slice(1), o.siblings)), r)
        : '';
    },
    wy = (e) => {
      let t;
          ...
          if (
            !(
              ('background-color' === t &&
                ...
                ((n = Cy.getStyle(e.getBody(), t, !0)), '#ffffff' === Pc(n).toLowerCase())) ||
                  ...
                  ? (p(o) || (o = [o]),
                    $(o, (e) => {
                      v(e.deep) && (e.deep = !Yc(e)),
                        ...
                        Yc(e) && Xc(e) && ((e.mixed = !0), (e.block_expand = !0)),
      ...
      return (
        ...
        })(e),
        {
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) => Nv(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: O(ky, e),
        }
      );
    },
              ...
              e.on('keyup', (n) => {
                ...
                n.isDefaultPrevented() ||
                  ...
                  o.get() &&
                    t.typing &&
                    !1 === Cv(hv(e), t.data[0]) &&
                    (!1 === e.isDirty() && e.setDirty(!0), e.dispatch('TypingUndo'), o.set(!1), e.nodeChanged()));
              }),
              e.on('keydown', (e) => {
                const s = e.keyCode;
                    ...
                    ((e, t) => {
                      ...
                      ? ((e, t) =>
                          e && Mo(t.nextSibling)
                            ...
                            : M.none())(t, n.getNode(!1 === t)).fold(() => mC(e, t, n), M.some)
                      : mC(e, t, n).bind((t) =>
                          ((e, t, n) =>
                            n.fold(
      ...
      e
        ? ((e) => {
            if (vC(e.previousSibling))
              return CC(e.previousSibling) || e.previousSibling.appendData(ur), e.previousSibling;
  ...
  const mx = (e, t, n, o, r, s) => {
    ...
    jx = (e, t) =>
      (e || 'table' === Mt(t) ? 'margin' : 'padding') + ('rtl' === $n(t, 'direction') ? '-right' : '-left'),
    Vx = (e) => {
      const t = $x(e);
      return (
        !e.mode.isReadOnly() &&
    ...
    $x = (e) => {
      return K(
        ...
        (e) => !Hx(e) && !((e) => wn(e).exists(Hx))(e) && $o(e, (e) => Po(e.dom) || Mo(e.dom)).exists((e) => Po(e.dom))
      );
      var t;
    },
    qx = (e, t) => {
    ...
    ew = (e) => {
      ...
      if (!o.isValidChild(u, c.toLowerCase()) || ((e, t, n) => V(Xf(mn(n), mn(t)), (t) => Qx(e, t.dom)))(r, a, s))
        return;
      const m = n.getRng(),
        f = m.startContainer,
        g = m.startOffset,
    ...
    uw = (e, t) => {
      ...
      return ((e, t) => {
        ...
        if (
          ((e, t, n) =>
            t ? ((e, t) => nx(e, t).breakAt.isNone())(e.dom, n) : ((e, t) => tx(e, t).breakAt.isNone())(e.dom, n))(
            n,
            t,
            o
          )
    ...
    hw = (e, t) =>
      Q(
        ((e, t) => ee(((e) => H(e, (e) => ({ ...fw, action: S, ...e })))(e), (e) => (gw(e, t) ? [e] : [])))(e, t),
        (e) => e.action()
      ),
    bw = (e, t) =>
      ce(
        ((e, t) =>
          ee(((e) => H(e, (e) => ({ ...fw, action: () => M.none(), ...e })))(e), (e) => (gw(e, t) ? [e] : [])))(e, t),
        (e) => e.action()
      ),
    vw = (e, t) => {
      const n = t ? $d.Forwards : $d.Backwards,
    ...
    $w = (e, t) => {
      ...
      return ((e, t) =>
        ((e, t, n = L) =>
          n(t) ? M.none() : j(e, Mt(t)) ? M.some(t) : qo(t, e.join(','), (e) => pn(e, 'table') || n(e)))(
          ['td', 'th'],
          e,
          t
  ...
  const ak = (e, t, n) => (e.stype === sk.Error ? t(e.serror) : n(e.svalue)),
        ...
        xe(o, e).fold(
          ...
          (e) =>
            ((e, t, n, o) =>
              xe(n, o).fold(
                () =>
                  ((e, t, n) => uk(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + ck(t)))(
                    e,
                    n,
                    o
                  ),
      ...
      switch (e.tag) {
        case 'required':
          return ((e, t, n, o) =>
            xe(t, n).fold(
              () =>
                ((e, t, n) => uk(e, () => 'Could not find valid *required* value for "' + t + '" in ' + ck(n)))(
                  e,
                  n,
                  t
                ),
    ...
    Sk = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) => (e.stype === sk.Error ? { stype: sk.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({
            input: n,
            errors: e,
          })))(e, t, n)),
    ...
    jk = (e, t, n) =>
      Uk(
        ...
        ((e) => {
          return (
            (t = (t) =>
              j(e, t) ? di.value(t) : di.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`)),
            vk((e) => t(e).fold(lk, ik))
          );
          var t;
        })(n)
    ...
    OS = (e, t) => {
      ...
      const u = e.dom,
        ...
        h = (t) => {
          ...
          if (((n = t || 'TABLE' === d || 'HR' === d ? u.create(t || p) : s.cloneNode(!1)), (a = n), !1 === Pi(e)))
            ...
            do {
              if (l[i.nodeName]) {
                ...
                (r = i.cloneNode(!1)),
                  u.setAttrib(r, 'id', ''),
                  n.hasChildNodes() ? (r.appendChild(n.firstChild), n.appendChild(r)) : ((a = r), n.appendChild(r));
              }
        ...
        v = () => {
          (a = /^(H[1-6]|PRE|FIGURE)$/.test(d) && 'HGROUP' !== w ? h(p) : h()),
            Mi(e) && ES(u, l) && u.isEmpty(s) ? (a = u.split(l, s)) : u.insertAfter(a, s),
            bS(e, a);
        };
      mm(u, g).each((e) => {
        ...
        (o = ((e, t, n, o, r) => {
          ...
          if (((a = u.getParent(o, u.isBlock)), !a || !ES(u, a))) {
            if (
              ((a = a || m),
              (c =
                a === e.getBody() || ((e) => e && /^(TD|TH|CAPTION)$/.test(e.nodeName))(a)
                  ? a.nodeName.toLowerCase()
                  : a.parentNode.nodeName.toLowerCase()),
              !a.hasChildNodes())
            )
              return (s = u.create(t)), AS(e, s), a.appendChild(s), n.setStart(s, 0), n.setEnd(s, 0), s;
            for (l = o; l.parentNode !== a; ) l = l.parentNode;
            for (; l && !u.isBlock(l); ) (i = l), (l = l.previousSibling);
            if (i && e.schema.isValidChild(c, t.toLowerCase())) {
              for (s = u.create(t), AS(e, s), i.parentNode.insertBefore(s, i), l = i; l && !u.isBlock(l); )
        ...
        /^(LI|DT|DD)$/.test(d) && u.isEmpty(s)
          ? ((e, t, n, o, r) => {
              ...
              if (wS(n, o, !0) && wS(n, o, !1))
                ...
                yS(n, 'LI')
                  ? (s.insertAfter(l, xS(n)), l.appendChild(s.doc.createTextNode(' ')), l.appendChild(n))
          ...
          : s !== e.getBody() &&
            (hr(s)
              ...
              : ((n = ((e) => {
                  const t = e.cloneRange();
                  return (
                    t.setStart(e.startContainer, NS(!0, e.startContainer, e.startOffset)),
    ...
    s_ = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        ...
        return FC(o, e.getBody(), r)
          ...
          .map(
            (o) => () => r_(n, t)(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e))
          );
      }
      return M.none();
    },
              ...
              !1 === t.isDefaultPrevented() &&
                ((e, t) => {
                  bw([{ keyCode: Uu.SPACEBAR, action: pw(s_, e) }], t).each((n) => {
                    t.preventDefault(),
                      hS(e, 'insertText', { data: ' ' }).isDefaultPrevented() ||
  ...
  const d_ = N('x-tinymce/html'),
    ...
    v_ = (e) =>
      b_(e, [
        ...
        [/( ?)<span class="Apple-converted-space">\u00a0<\/span>( ?)/g, (e, t, n) => (t || n ? dr : ' ')],
                      ...
                      if ('br' !== n) {
                        if ('wbr' !== n)
                          if ((r[n] && (o += ' '), s[n])) o += ' ';
                            ...
                            if (
                              (3 === e.type && (o += e.value), !(e.name in t.getVoidElements()) && (e = e.firstChild))
                            )
                              do {
                                i(e);
                              } while ((e = e.next));
    ...
    D_ = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on('keydown', (e) => {
          ((e) => (Uu.metaKeyPressed(e) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode))(e) &&
            !e.isDefaultPrevented() &&
  ...
  const W_ = (e, t) => Math.abs(e.left - t),
    ...
    iE = (e) => {
      ...
      const d = (e) => e !== r && (sE(e) || Fo(e)) && n.isChildOf(e, r),
        c = (n, o, r, a = !0) =>
          e.dispatch('ShowCaret', { target: o, direction: n, before: r }).isDefaultPrevented()
            ? null
        ...
        f = (t) => {
          const o = e.schema.getVoidElements(),
            ...
            l = t.endOffset;
          return (
            we(o, s.nodeName.toLowerCase()) ? (0 === a ? r.setStartBefore(s) : r.setStartAfter(s)) : r.setStart(s, a),
            we(o, i.nodeName.toLowerCase()) ? (0 === l ? r.setEndBefore(i) : r.setEndAfter(i)) : r.setEnd(i, l),
            r
          );
        },
        g = (o, s) => {
          ...
          e.on('mousedown', (o) => {
            ...
            sE(a)
              ...
              : Q_(r, o.clientX, o.clientY).each((n) => {
                  var r;
                  o.preventDefault(),
                    (r = c(1, n.node, n.position === q_.Before, !1)) && t.setRng(r),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(), 'drop' === t.type && oy(e, 'Dropped file type is not supported'));
                      }
                    },
                    n = (n) => {
                      Qm(e, n.target) && t(n);
    ...
    fE = (e, t, n, o = !0) => {
      ...
      t.deleteContents(),
        o &&
          !n(t.startContainer) &&
          (No(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer),
          No(t.endContainer) && 0 === t.endContainer.data.length && e.remove(t.endContainer),
          mE(e, r, n),
          r !== s && mE(e, s, n));
    },
        ...
        o = ((e, t) => {
          ...
          return gE(e, o)
            ...
            .bind((e) => {
              ...
              return r.map((t) =>
                Bt.trim(o).length === t.start.length ? [] : [{ pattern: t, range: dE(n.getRoot(), e, 0, e, 0) }]
              );
            })
            .getOr([]);
        })(e, t.blockPatterns);
            ...
            e.execCommand('mceInsertNewLine'),
              r.each((t) => {
                ...
                n.data.charAt(t.offset - 1) === lr &&
                  (n.deleteData(t.offset - 1, 1), mE(e.dom, n.parentNode, (t) => t === e.dom.getRoot()));
              });
          }
        ),
        !0)
      ...
      e.on(
        ...
        (t) => {
          ...
          13 !== t.keyCode ||
            ...
            (NE(e, ((n = Xl(e)), { inlinePatterns: pi(n), blockPatterns: gi(n) })) && t.preventDefault());
        },
        !0
      ),
        e.on('keyup', (t) => {
              ...
              (() => {
                ...
                e.on('keypress', (t) => {
                  ...
                  if (!f(t) && (8 === t.keyCode || 46 === t.keyCode) && o())
                    return (r = n()), e.getDoc().execCommand('delete', !1, null), r(), t.preventDefault(), !1;
                }),
    ...
    zE = (e) => {
      ...
      (o.disabled = !0),
        (e.readonly = Sl(e)),
        e.readonly ||
          (e.inline && 'static' === BE.getStyle(o, 'position', !0) && (o.style.position = 'relative'),
        ...
        ((e) => {
          ...
          if (m(t)) {
            ...
            (e.theme = n(e, ey.urls[t]) || {}),
              x(e.theme.init) && e.theme.init(e, ey.urls[t] || e.documentBaseUrl.replace(/\/$/, ''));
          } else e.theme = {};
        })(e),
        ((e) => {
          const t = cl(e),
              ...
              ((e, t) => {
                ...
                (r.onload = () => {
                  ...
                  (e.iframeHTML = ((e) => {
                    ...
                    Ei(e) !== e.documentBaseUrl && (t += '<base href="' + e.documentBaseURI.getURI() + '" />'),
                      (t += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />');
                    const n = Ni(e),
                      o = Ri(e),
                      r = e.translate(Bl(e));
                    return (
                      Ai(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + Ai(e) + '" />'),
    ...
    iN = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = bg(o, Ua.fromRangeStart(t)) ? n.replace(/^ /, '&nbsp;') : n.replace(/^&nbsp;/, ' ')),
        ...
        .bind((n) =>
          ((e, t, n) =>
            Ap(
              mn(n),
              (t) =>
                ((t) => Wn(t, e).orThunk(() => ('font' === Mt(t) ? xe(dN, e).bind((e) => Kt(t, e)) : M.none())))(t),
              (e) => bn(mn(t), e)
                ...
                e.removed ||
                  (t
                    ...
                    : ((e) => {
                        ...
                        e.inline || (Nt.browser.isOpera() || tf(n), e.getWin().focus()),
                          (Nt.browser.isFirefox() || e.inline) && (tf(n), ef(e, o)),
                          of(e);
                      })(e));
              })(e, o);
            },
    ...
    qN = (e) => {
      ...
      jN(VN(e.toLowerCase(), '+'), (e) => {
        e in $N
          ...
          : ((n.charCode = e.charCodeAt(0)), (n.keyCode = HN[e] || e.toUpperCase().charCodeAt(0)));
      });
      const r = [n.keyCode];
  ...
  class WN {
        ...
        (!t.hasModifier(e) && !t.isFunctionKey(e)) ||
          ...
          (jN(t.shortcuts, (n) => {
            if (t.matchShortcut(e, n))
              return (
                (t.pendingPatterns = n.subpatterns.slice(0)), 'keydown' === e.type && t.executeShortcutAction(n), !0
              );
          }),
    ...
    createShortcut(e, t, n, o) {
      ...
      return (
        (r[r.length - 1] = Bt.extend(r[r.length - 1], { func: n, scope: o || this.editor })),
  ...
  class QN {
    constructor(e, t, n) {
      ...
      (this.options = ((e, t) => {
        ...
        ((e) => {
          ...
          t('id', { processor: 'string', default: e.id }),
            ...
            e.on('ScriptsLoaded', () => {
              t('directionality', { processor: 'string', default: $s.isRtl() ? 'rtl' : void 0 }),
                t('placeholder', { processor: 'string', default: yi.getAttrib(e.getElement(), 'placeholder') });
            });
        })(o);
      ...
      const l = Ki(o);
      l && (Us.ScriptLoader._setReferrerPolicy(l), Is.DOM.styleSheetLoader._setReferrerPolicy(l)),
    ...
    render() {
      ((e) => {
        ...
        e.on('remove', () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) => Yo.forElement(e, { contentCssCors: _l(t), referrerPolicy: Ki(t) }))(
            o,
            e
          )),
          bl(e)
        ...
        s &&
          ...
          vl(e) &&
            !Eo(e.getElement()) &&
            (KE.insertAfter(KE.create('input', { type: 'hidden', name: t }), t), (e.hasHiddenInput = !0)),
    ...
    getParam(e, t, n) {
      ...
      return (
        o.isRegistered(e) ||
          (C(n) ? o.register(e, { processor: n, default: t }) : o.register(e, { processor: P, default: t })),
    ...
    show() {
      ...
      e.hidden &&
        ((e.hidden = !1),
        e.inline ? (e.getBody().contentEditable = 'true') : (GN.show(e.getContainer()), GN.hide(e.id)),
        e.load(),
        e.dispatch('show'));
    }
    hide() {
          ...
          JN.unbind(window, 'ready', s),
            ...
            Bt.each(i, (e) => {
              ...
              (n = t.get(e.id)) &&
                ...
                (sR(n), n.unbindAllNativeEvents(), n.destroy(!0), (n.removed = !0), (n = null));
            }),
    ...
    gR = {
      ...
      findBestRelativePosition: (e, t, n, o) => {
        ...
        for (s = 0; s < o.length; s++)
          if (((r = mR(e, t, o[s])), r.x >= n.x && r.x + r.w <= n.w + n.x && r.y >= n.y && r.y + r.h <= n.h + n.y))
            return o[s];
        return null;
      },
      intersect: (e, t) => {
      ...
      clamp: (e, t, n) => {
        ...
        const i = t.x + t.w,
          ...
          m = cR(0, a - l);
        return (
          (o += d), (r += c), n && ((s += d), (a += c), (o -= u), (r -= m)), (s -= u), (a -= m), fR(o, r, s - o, a - r)
        );
      },
      create: fR,
