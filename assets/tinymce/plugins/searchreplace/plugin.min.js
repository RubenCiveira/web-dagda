...
!(function () {
  ...
  const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
    ...
    W = (e, t, n, o, r) => {
      if (
        ((e, t) =>
          ...
          M(e, t) ||
          R(e, t) ||
          ((e, t) => 'true' === e.getContentEditable(t) && 'false' === e.getContentEditableParent(t.parentNode))(e, t))(
          e,
          n
        )
      )
    ...
    J = (e, t, n) => {
      ...
      let r = o.index;
      const s = e.dom;
      (n = !1 !== n) ? (r + 1 === o.count ? (r = 0) : r++) : r - 1 == -1 ? (r = o.count - 1) : r--,
    ...
    ee = (e, t, n, o, r) => {
      ...
      for (let t = 0; t < d.length; t++) {
        ...
        if (r || u === s.index) {
          for (n.length ? ((d[t].firstChild.nodeValue = n), K(d[t])) : L(e.dom, d[t]); d[++t]; ) {
