  ...
  const s = 'undefined' != typeof window ? window : Function('return this;')(),
      ...
      return (
        ...
        (function (e) {
          ...
          (e.languages.java = e.languages.extend('clike', {
            ...
            'class-name': [
              a,
              { pattern: RegExp(n + /[A-Z]\w*(?=\s+\w+\s*[;,=()])/.source), lookbehind: !0, inside: a.inside },
            ],
            keyword: t,
    ...
    g = (e) => {
      const s = ((e) =>
        ...
        r = ((c = s), ((e, t) => (0 < e.length ? n.some(e[0]) : n.none()))(c)).fold(t(''), (e) => e.value),
        i = ((e, t) =>
          d(e).fold(
            () => t,
            (e) => {
      ...
      ((e) => {
        e.on('PreProcess', (t) => {
          ...
          h.each(h.grep(a, c), (e) => {
            ...
            let a;
            for (
              n.setAttrib(e, 'class', p(n.getAttrib(e, 'class'))), n.setAttrib(e, 'contentEditable', null);
              (a = e.firstChild);
          ...
          e.on('SetContent', () => {
            const t = e.dom,
              n = h.grep(t.select('pre'), (e) => c(e) && 'false' !== e.contentEditable);
            n.length &&
              e.undoManager.transact(() => {
                h.each(n, (n) => {
                  h.each(t.select('br', n), (t) => {
                    t.parentNode.replaceChild(e.getDoc().createTextNode('\n'), t);
                  }),
