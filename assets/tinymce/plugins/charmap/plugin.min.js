...
!(function () {
  ...
  const u = (e) => (t) => t.options.get(e),
    ...
    p = 'User Defined',
    d = (e) => {
      return m(e) ? ((t = e), c.grep(t, (e) => m(e) && 2 === e.length)) : 'function' == typeof e ? e() : [];
      var t;
    },
    f = (e) => {
      const t = ((e, t) => {
      ...
      return (
        ((e, t) => {
          for (let t = 0, i = e.length; t < i; t++)
            ((e, t, a) =>
              !!w(b(e).toLowerCase(), a) || w(t.toLowerCase(), a) || w(t.toLowerCase().replace(/\s+/g, ''), a))(
              (n = e[t])[0],
              n[1],
              r
            ) && a.push(n);
      ...
      const n = () => [
        ...
        u = {
          ...
          body:
            1 === a.length
              ? { type: 'panel', items: n() }
              : { type: 'tabpanel', tabs: l(a, (e) => ({ title: e.name, name: e.name, items: n() })) },
