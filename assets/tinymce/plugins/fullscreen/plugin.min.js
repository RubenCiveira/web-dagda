...
!(function () {
  ...
  const A = (e) => (t) => ((e) => e.dom.nodeType)(t) === e,
          ...
          ((e) => {
            if (H() && a(e.target)) {
              ...
              if (R(t) && a(t.dom.shadowRoot) && e.composed && e.composedPath) {
                ...
                if (t) return ((e, t) => (0 < e.length ? f.some(e[0]) : f.none()))(t);
              }
            }
    ...
    ne = [
      ...
      { name: 'Opera', versionRegexes: [ee, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: te('opera') },
    ...
    re = [
      ...
      { name: 'macOS', search: te('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
            ...
            .bind((e) =>
              ((e, t) =>
                ((e, t) => {
                  ...
                  }).map((e) => ({ current: e.name, version: Q.nu(parseInt(t.version, 10), 0) }));
                }))(r, e)
            )
            .orThunk(() =>
              ((e, t) =>
  ...
  const Te = (e, t) => ({ left: e, top: t, translate: (n, r) => Te(e + n, t + r) }),
    ...
    Re = (e) => {
      ...
      return Ce(t).fold(
        ...
        (e) => Ae(Math.max(e.pageLeft, r.left), Math.max(e.pageTop, r.top), e.width, e.height)
      );
    },
    Le = (e, t, n) =>
      Ce(n)
  ...
  const We = (e) => {
    ...
    je = (e) => {
      const t = ((e, t) => {
        ...
        return '' !== r || _(e) ? r : ((e, t) => (T(e) ? e.style.getPropertyValue(t) : ''))(n, t);
      })(e, 'background-color');
      return void 0 !== t && '' !== t
