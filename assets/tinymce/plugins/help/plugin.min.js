    ...
    v = (e) => {
      const t = (e) => `<a href="${e.url}" target="_blank" rel="noopener">${e.name}</a>`,
                ...
                ((e, n) => {
                  ...
                  ((e, t, n) => {
                    ...
                    (e) => {
                      ...
                      return t({ name: n, url: `https://www.tiny.cloud/docs/tinymce/6/${e.slug}/` });
                    }
                  );
                  var a, o;
                })(e, n) +
        ...
        h = {
          ...
          presets: 'document',
          html: [
            ((e) => (null == e ? '' : '<div data-mce-tabstop="1" tabindex="-1">' + n(e) + '</div>'))(e),
            (() => {
              const e = c(k, ({ key: e, type: t }) => 'autocorrect' !== e && 'premium' === t),
    ...
    const { tabs: a, names: o } = ((e, t) => {
        const a = y(),
          ...
          r = (() => {
            ...
            const n =
              ...
              ((e = f.majorVersion), (t = f.minorVersion), (0 === e.indexOf('@') ? 'X.X.X' : e + '.' + t) + '</a>');
            return {
              name: 'versions',
              title: 'Version',
              items: [
        ...
        return s.from(n(e)).fold(
          ...
          (e) =>
            ((e, t) => {
              const n = {},
                a = l(e, (e) => ('string' == typeof e ? (m(t, e) && (n[e] = t[e]), e) : ((n[e.name] = e), e.name)));
