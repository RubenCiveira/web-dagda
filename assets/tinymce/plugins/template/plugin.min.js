...
!(function () {
  ...
  const c = (e) => (t) => t.options.get(e),
    ...
    M = (e, t, a = new Date()) => {
      ...
      return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
        ...
        '%m',
        _(a.getMonth() + 1, 2)
      )).replace('%d', _(a.getDate(), 2))).replace('%H', '' + _(a.getHours(), 2))).replace(
        '%M',
        '' + _(a.getMinutes(), 2)
      )).replace('%S', '' + _(a.getSeconds(), 2))).replace('%I', '' + (((a.getHours() + 11) % 12) + 1))).replace(
        '%p',
        a.getHours() < 12 ? 'AM' : 'PM'
  ...
  const A = Object.hasOwnProperty,
    ...
    I = (e) =>
      e.replace(/["'<>&]/g, (e) => {
        return ((t = D), (a = e), ((e, t) => A.call(e, t))(t, a) ? C.from(t[a]) : C.none()).getOr(e);
        var t, a;
      }),
    N = (e, t) => {
      const a = (e, t) =>
          ...
          i = (t, n, r) => {
            const s = ((e, t) => {
                ...
                if (-1 === t.indexOf('<html>')) {
                  ...
                  const l = b(e),
                    ...
                    i =
                      ...
                      (O.os.isMacOS() || O.os.isiOS() ? 'e.metaKey' : 'e.ctrlKey && !e.altKey') +
              ...
              c = [
                ...
                { type: 'htmlpanel', html: `<p aria-live="polite">${I(n.value.description)}</p>` },
