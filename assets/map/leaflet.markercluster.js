...
!(function (e, t, i) {
  (L.MarkerClusterGroup = L.FeatureGroup.extend({
    ...
    _addLayer: function (e, t) {
      ...
      for (
        this.options.singleMarkerMode && this._overrideMarkerIcon(e), e.on(this._childMarkerEventHandlers, this);
        t >= o;
        t--
      ) {
    ...
    _checkBoundsMaxLat: function (e) {
      var t = this._maxLat;
      return (
        t !== i && (e.getNorth() >= t && (e._northEast.lat = 1 / 0), e.getSouth() <= -t && (e._southWest.lat = -1 / 0)),
        e
      );
    },
            ...
            if (t !== n._zoom)
              for (var r = n._markers.length - 1; r >= 0; r--) {
                ...
                i.contains(s._latlng) &&
                  (e && ((s._backupLatlng = s.getLatLng()), s.setLatLng(e), s.clusterHide && s.clusterHide()),
      ...
      _animationSpiderfy: function (e, t) {
        ...
        for (u._forceLayout(), u._animationStart(), n = e.length - 1; n >= 0; n--)
          (h = _.layerPointToLatLng(t[n])),
            ...
            f && ((s = r._spiderLeg), (o = s._path), (o.style.strokeDashoffset = 0), s.setStyle({ opacity: g }));
        this.setOpacity(0.3),
          (u._ignoreMove = !1),
          setTimeout(function () {
    ...
    L.Marker.include({
      refreshIconOptions: function (e, t) {
        ...
        return (
          L.setOptions(i, e), this.setIcon(i), t && this.__parent && this.__parent._group.refreshClusters(this), this
        );
      },
    });
})(window, document);
